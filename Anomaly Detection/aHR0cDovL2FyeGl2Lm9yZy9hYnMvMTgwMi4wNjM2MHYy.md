...
- **OC-NN 목적 함수:**
  ...
  $$ \min_{\mathbf{w}, \mathbf{V}, r} \frac{1}{2}\|\mathbf{w}\|^2_2 + \frac{1}{2}\|\mathbf{V}\|^2_F + \frac{1}{\nu} \cdot \frac{1}{N} \sum_{n=1}^{N} \max(0, r - \langle\mathbf{w}, g(\mathbf{V}\mathbf{X}_{n:})\rangle) - r $$
