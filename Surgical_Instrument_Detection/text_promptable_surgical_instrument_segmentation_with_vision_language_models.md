...
* **최고 성능 달성:** EndoVis2017 및 EndoVis2018 데이터셋에서 기존 감독 학습 방법들과 기존 텍스트 프롬프트 가능한 자연 이미지 분할 방법(CRIS, CLIPSeg)을 월등히 능가하는 성능을 보였습니다. 예를 들어, EndoVis2017에서 Ch_IoU +7.36%, ISI_IoU +5.84%, mc_IoU +9.67%의 개선을 달성했습니다.
...
* **SAM과의 비교:** 커뮤니티 기반의 SAM 변형(lang-segment-anything)은 의료 프롬프트에서 낮은 성능(예: EndoVis2018에서 Ch_IoU 17.77%)을 보이며, 본 제안 방법이 의료 도메인에 특화된 성능 우위를 가짐을 시사합니다.
