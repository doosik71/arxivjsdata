...
- **다중 스케일 표현 학습의 역할**: Mamba 기반 모델, 특히 MSv4와 같은 다중 스케일 전략을 사용할 때, 다양한 크기의 해부학적 구조를 포함하는 복잡한 분할 작업에서 미세한 디테일과 전역적 문맥 정보를 효과적으로 캡처할 수 있습니다. Mamba는 본질적으로 장거리 종속성 모델링에 효율적이므로, Transformer에 비해 다중 스케일 전략으로부터 얻는 _상대적인_ 성능 향상은 작을 수 있습니다.
